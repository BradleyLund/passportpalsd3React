// Single source of truth for country names and code mappings.
// Country display names are keys; ISO 3166-1 alpha-2 (for flags) and alpha-3
// (for the GeoJSON / visa CSV) codes are values.
...
export const COUNTRIES = Object.keys(COUNTRY_DATA).sort();

export const COUNTRY_TO_ISO2 = Object.fromEntries(
  Object.entries(COUNTRY_DATA).map(([name, { iso2 }]) => [name, iso2])
);

export const COUNTRY_TO_ISO3 = Object.fromEntries(
  Object.entries(COUNTRY_DATA).map(([name, { iso3 }]) => [name, iso3])
);

export const ISO3_TO_COUNTRY = Object.fromEntries(
